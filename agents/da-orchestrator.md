...
- Available MCPs / tools listed in session (e.g., `<org-data-mcp>`, `<org-catalog>`, `google-drive`)
...
Full protocol + 3 worked examples (<product> report / insight correlation / DuckDB prototype): `${CLAUDE_PLUGIN_ROOT}/skills/prof-data-analyst/references/suggestion-protocol.md`.
