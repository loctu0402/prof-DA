...
Invoke the `da` skill in **query mode**. Read these references before acting:
...
- Try semantic / metric layer FIRST (Cube.js / dbt-metrics / <org-sql-agent> / LookML) before raw SQL
