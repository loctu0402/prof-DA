...
Encodes a complete DA discipline (workflow rules + style polish + coding rigor) into 7 routable modes plus bundled scripts. Designed to be portable across companies — no hard dependency on any specific data warehouse, BI tool, notification channel, or chart theme. BigQuery, <organization>-style semantic layer, and shared chart themes are referenced as concrete examples but treated as replaceable.
