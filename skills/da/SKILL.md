...
| **model** | "data modeling", "build pipeline mới", "design DWH", "setup mart", "dbt project", "/prof-DA:model" | `references/mode-model.md` |
| **query** | "viết SQL", "query data", "lấy data", "NL→SQL", "/prof-DA:query" | `references/mode-query.md` |
| **process** | "process data", "ML case study", "M1 / M2 / M3", "feature engineering", "EDA notebook", "DWH", "data audit", "data quality", "quality check", "kiểm tra data", "clean data", "data cleaning", "/prof-DA:process" | `references/mode-process.md` (Phase 2 — Quality Audit + Phase 3 — Cleaning are the standalone-discoverable parts) |
