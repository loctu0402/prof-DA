...
Invoke when user asks: "tôi có 1 yêu cầu mới", "stakeholder muốn", "tôi cần plan", "frame project mới", "metric define", "không biết bắt đầu từ đâu", "scope project", "kickoff", "/prof-DA:frame".
...
| `/prof-DA:model` | New data modeling pipeline needed (TH2 path) |
