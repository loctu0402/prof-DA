...
Invoke when user asks: "build data model", "data modeling", "design DWH", "build pipeline mới", "setup mart", "dbt project", "tạo bảng fact", "data architecture", "/prof-DA:model".
