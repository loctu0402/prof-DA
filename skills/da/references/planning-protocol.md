...
- Schema + SQL known → `/prof-DA:query`
- Need to wrangle/EDA → `/prof-DA:process`
- Need to build new pipeline → `/prof-DA:model` (modeling) → `/prof-DA:automate` (scheduling)
- Hypothesis already framed → `/prof-DA:insight`
