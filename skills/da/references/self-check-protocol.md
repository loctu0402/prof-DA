...
- [ ] Rung 1: baseline stated (DoD / WoW / MoM / YoY / canonical / <product-b> expected)
...
- [ ] <organization> theme applied (Matplotlib `<organization>.apply_theme()` or Plotly `<organization>_plotly_theme`)
