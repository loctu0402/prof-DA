...
## Worked example — <product> signup classifier

Setup: build a model predicting whether a new user will sign up for <product> in their first 30 days. Outcome is imbalanced (~5% positive).

Setup:
- 100,000 users, 5% positive (5,000 signups)
- Features: age, <organization> tenure, average balance, transaction frequency, geo
