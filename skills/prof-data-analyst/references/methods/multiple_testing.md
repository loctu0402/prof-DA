...
Setup: the <product> campaign DiD from `methods/did.md` was run on 6 outcomes simultaneously (cashout amount, cashout count, AUM, login frequency, screen views, churn rate). All 6 p-values reported.
