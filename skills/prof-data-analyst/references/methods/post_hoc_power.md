...
Setup: in the same <product> campaign analysis, the screen-views outcome had a DiD p-value of 0.07 → "not significant." Stakeholder asks: does this mean no effect, or weak power?
