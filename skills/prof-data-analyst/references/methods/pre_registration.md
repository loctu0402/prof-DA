...
## Worked example — <product> campaign pre-reg

The <product> Tier 3 campaign analysis (running example throughout the causal specs) had this pre-reg committed at 2026-03-10, before data was pulled:
