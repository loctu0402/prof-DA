...
## Worked example — power-user <product> conversion

Setup: among <organization> users who have NEVER used <product>, did a subset who voluntarily clicked "Learn more" (treated) eventually deposit more once they did sign up, vs comparable users who didn't click?

Setup:
- Treated: ~50k users who clicked "Learn more" in Q1 2026
- Control: 2M users who didn't click
- Covariates: age, tenure on <organization>, average wallet balance, transaction frequency, geo
- Outcome: <product> AUM at month-6 post-signup
...
- ATT: +3.2M VND in <product> AUM at month-6 (95% CI: +2.8M to +3.6M)
