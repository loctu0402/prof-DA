...
html = open("output/<product>_daily_2026-05-08.html").read()
soup = BeautifulSoup(html, "html.parser")
# ... patch logic ...
open("output/<product>_daily_2026-05-08_v2.html", "w").write(str(soup))
```
...
- the premium tier sales: `<product>_plus_9k` (2025+, single 9k) vs `fct_subscription` (2026+, 3 tiers) — UNION for full history
...
See `knowledge_<product>_app_mcp_fetch_pure_python.md`.
