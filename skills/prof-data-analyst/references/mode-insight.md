...
RIGHT: "Oil price +31% in March (FACT) → transport + food prices ↑ (MECHANISM) → households reallocate cash toward expenses (BEHAVIORAL CHANGE) → withdrawal from <organization> <product> for daily payments (PRODUCT IMPACT) → Payment Cashout +13.2% same period, daily_user_mart section 4.1 (EVIDENCE)"
