...
4. Worked example (<product> daily snapshot pattern)
5. Anti-patterns
...
- **<product>**: Tài khoản Tích Trữ — sản phẩm gửi tiết kiệm trên app, lãi suất X% năm, kỳ hạn linh hoạt.
- **Cashout**: Sự kiện rút tiền ra khỏi <product> về <organization> wallet, không phải về bank.
```
...
## Worked example: <product> daily snapshot opening

```
## Bối cảnh & Câu hỏi (SCQR)

Tình hình: Sản phẩm <product> đang chạy tháng thứ 4 của 2026, AUM 5.2 nghìn tỷ.
...
- **<product>**: Tài khoản Tích Trữ — sổ tiết kiệm trên app.
- **AUM**: Tài sản đang quản lý — tổng số dư tất cả <product> chưa cashout.
- **Cashout**: Rút tiền từ <product> về wallet <organization>.
