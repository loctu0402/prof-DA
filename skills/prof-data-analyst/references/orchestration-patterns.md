...
### Anatomy (<product>-style, plain DAG)
...
<event-system>-style pattern verified in production at <organization> (multi-domain analytics platform). Pattern is portable to any dbt + Airflow combination.
