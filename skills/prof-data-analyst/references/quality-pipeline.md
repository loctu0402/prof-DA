...
**Why (Empirical):** Past incidents — <product> mart T-2 lag, duplicate rows on backfill, fct_ vs legacy union — happen at this gate. The 6-step EDA pass is the structured catch.
