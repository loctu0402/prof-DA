...
For the <organization> Semantic Cube (<semantic-tech> + Cube.js) implementation specifically, see `references/org-extensions.md`.
...
- <organization> Semantic Cube docs (public) → `https://<semantic-layer-host>/docs/intro`
