...
For the <organization> Semantic Cube (<semantic-tech> + Cube.js) implementation specifically, see `references/org-extensions.md` + the full Semantic Cube reference at `<workspace>/notes/loctu-pkm/1-notes/semantic-cube-reference.md`.
...
- <organization>-specific implementation (<semantic-tech> + Cube.js + <org-data-mcp> MCP) → `references/org-extensions.md`
- Full Semantic Cube spec (<organization>) → `<workspace>/notes/loctu-pkm/1-notes/semantic-cube-reference.md`
