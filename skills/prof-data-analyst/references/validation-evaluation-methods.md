...
Why these rules — anomaly detection that uses last-N-months blindly will flag a normal-but-post-regime-shift point as anomalous because the slope was learned from a different regime. Past incident: <product-b> expected model + structural break = false anomalies; fix was exclude-break + last-3M window.
